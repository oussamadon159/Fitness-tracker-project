...
export function trainingRecucer(state = initialState,action:TrainingActions){
...
switch(action.type){
  ...
  return{
    ...state,
    activeTraining:{...state.availableExercises.find(ex=> ex.id === action.payload)} // we create an immualable copie of the object
  };
  case STOP_TRAINING:
  return{
    ...state,
